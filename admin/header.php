<?php include "../config/database.php"; //admin panelini veritabanına bağladık
      $site = $db->prepare("SELECT * FROM ayarlar");
      $site->execute();
      $ayarcek = $site->fetch(PDO::FETCH_ASSOC);

      include "kontrol.php";s
?>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <!-- Call Search -->
                    <li><a href="../" target="_blank" class="js-search" data-close="true"><i class="material-icons">desktop_mac</i></a></li>
                    <!-- #END# Call Search -->
